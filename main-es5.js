...
var AppComponent = /** @class */ (function () {
    function AppComponent(http) {
        ...
        this.col1 = "";
        this.val1 = "";
        this.http.get("http://localhost/api/ecommerce/products.php").subscribe(function (d) {
            _this.products = d;
        });
        this.http.get("http://localhost/api/ecommerce/tags.php").subscribe(function (d) {
            _this.tags = d;
        });
    }
    AppComponent.prototype._tags = function (str) {
        this.val1 = str;
    };
    AppComponent.prototype._sort = function (str) {
        this.col1 = str;
...
var ColPipe = /** @class */ (function () {
    function ColPipe() {
    }
    ColPipe.prototype.transform = function (a, col) {
        if (col) {
            return a.filter(function (item) { return item.tags == col; });
        }
        else {
            return a;
        }
...
var FilterPipe = /** @class */ (function () {
    ...
    FilterPipe.prototype.transform = function (a, s) {
        if (s) {
    ...
    SortPipe.prototype.transform = function (a, col, toggle) {
        if (col) {
            if (col == "tags" || col == "title" || col == "description" || col == "tags" || col == "image") {
                return a.sort(function (arr1, arr2) {
                    if (toggle) {
