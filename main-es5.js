...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.createNewTodo = function (x1, x2) {
        var id = 1;
        var title = x1.value;
        var desc = x2.value;
        var date = Date.now();
        ...
        if (this.todos.filter(function (item) { return item.title == title; }).length > 0) {
    ...
    AppComponent.prototype.edit = function (index, todo) {
        var title = prompt("new title", todo.title);
        var desc = prompt("new desc", todo.desc);
        this.todos[index].title = title;
        this.todos[index].desc = desc;
        this.save();
    };
    AppComponent.prototype.del = function (index) {
    ...
    AppComponent.prototype.sort1 = function () {
        var t = this.toggle;
        this.todos.sort(function (y, x) {
            return t ? (x["date"] - y["date"]) : (y["date"] - x["date"]);
        });
        this.toggle = !this.toggle;
    };
    AppComponent.prototype.sort2 = function () {
        var t = this.toggle;
        this.todos.sort(function (y, x) {
